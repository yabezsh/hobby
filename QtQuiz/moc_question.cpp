...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Question_t, stringdata) + ofs \
...
const QMetaObject Question::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Question.data,
      qt_meta_data_Question,  qt_static_metacall, 0, 0}
};
